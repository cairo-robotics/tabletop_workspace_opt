...
Usage:
    python3 scripts/eval_map_elites_tiers.py
    python3 scripts/eval_map_elites_tiers.py --scenes desk kitchen_prep
    python3 scripts/eval_map_elites_tiers.py --seeds 3 --n-trials 50  # quick test
"""
import sys
import os
import re
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "src", "scene_2d"))
import cv2
